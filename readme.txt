...
Tags: featured page, genesis, widget, featured content, Genesis Framework, genesiswp, page, page block
...
* Adds option to add a custom page title
...
* Genesis 3.0+ and HTML5 compatible
